...
<head>
    <meta charset="UTF-8">
    <title>Update Product Failed !</title>
...
<div class="container">
    <div class="row text-center">
        <div class="col-sm-6 col-sm-offset-3">
            <br><br> <h2 style="color: darksalmon">Failed to Update Product</h2>
            <br>
            <p style="color: darksalmon; font-size: large; font-family: Arial">Something went wrong. Sorry for the inconvenience.</p><br><br>
            <a href="SellerDashboard.jsp" action="SellerDashboard.jsp" class="btn btn-primary" style="font-size: medium"> Return to Dashboard</a>
            <br><br>
        </div>
